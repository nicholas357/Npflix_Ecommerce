  ...
  <div data-custom-class="body">
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <bdt className="question">
              <a
                href="https://ottflixnepal.netlify.app/"
                target="_blank"
                data-custom-class="link"
              >
                https://ottflixnepal.netlify.app/
              </a>
            </bdt>
          </span>{" "}
      ...
      >
        ...
        >
          ...
          <bdt className="block-component">
            email at <bdt className="question">npflixnepal@gmail.com</bdt>
            
            <bdt className="block-component" />
            <bdt className="block-component" />
            <bdt className="block-component">
              <bdt className="block-component">,&nbsp;</bdt>
              <bdt className="question">Nepal</bdt>
              <bdt className="statement-end-if-in-editor" />
            </bdt>
            .
          </bdt>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        ...
        <a data-custom-class="link" href="#addclause">
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <span data-custom-class="body_text">
              26. <bdt className="question">SHARING ACCOUNTS</bdt>
            </span>
          </span>
        </a>
        <bdt className="statement-end-if-in-editor">
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        ...
        <a data-custom-class="link" href="#addclauseb">
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <span data-custom-class="body_text">
              27. <bdt className="question">LIMITATION OF LIABILITY</bdt>
            </span>
          </span>
        </a>
        <bdt className="statement-end-if-in-editor" />
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <bdt className="block-component" />
        <a data-custom-class="link" href="#addclausec">
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <span data-custom-class="body_text">
              28. <bdt className="question"> INDEMNIFICATION</bdt>
            </span>
          </span>
        </a>
        <bdt className="statement-end-if-in-editor" />
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          in <bdt className="question">NPR</bdt>.
        </span>
      </div>
    </div>
    <div align="center" style={{ lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          <strong>
            ...
            <span style={{ color: "rgb(0, 58, 250)" }}>
              ...
              >
                <a
                  href="https://npflix.netlify.app/privacy-policy"
                  target="_blank"
                  data-custom-class="link"
                >
                  https://npflix.netlify.app/privacy-policy
                </a>
              </bdt>
            </span>
          </strong>
      ...
      >
        ...
        be <bdt className="question">__________</bdt>. The seat, or legal place,
        ...
        <bdt className="question">__________</bdt>. The governing law of these
      ...
      >
        <bdt className="question">
          <span style={{ fontSize: 15 }}>
            {" "}
            We offer sharing accounts for certain digital goods. We are not
            responsible for the performance or availability of sharing accounts.
            There is no refund policy for sharing accounts under any
            circumstances. We make no warranties or representations about the
            quality or duration of access to sharing accounts.
          </span>
        </bdt>
      </div>
      <div
      ...
      >
        <bdt className="question">
          <span style={{ fontSize: 15 }}>
            ...
            damages, liabilities, costs, and expenses arising out of your use of
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          >
            <bdt className="question">
              <strong>
                <bdt className="question">Kathmadu Nepal</bdt>
              </strong>
            </bdt>
            <span
              style={{
