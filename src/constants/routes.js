...
export const APPLE = '/spotify'
export const EPIC = '/gift-cards'
export const STEAM = '/top-ups'
export const MICROSOFT = '/softwares'
export const PLAYSTATION ='/subscriptions'
